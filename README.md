...
This folder is intended for a separate GitHub Pages repository named:
...
After publishing the `hlbkomer.github.io` repository, update Google Cloud branding to use those root URLs.
